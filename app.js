App({
  globalData: {
    ...
    getUserinfo: false,
    config: {
      cdn:'http://img.wondfun.com/',
      apiUrl: 'https://www.wondfun.com/wanba/api/',
      imgUrl: 'http://img.wondfun.com/',
      uploadUrl: 'https://www.wondfun.com/',
      mapSubkey: 'EFGBZ-UXZCQ-KYI5A-GQZOD-CDPD7-OOFKX',
      userApiUrl: 'https://www.wondfun.com/wanba/api/getopenid-wondfun.php'
    }
